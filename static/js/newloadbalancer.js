...
(function($, eucalyptus) {
  $.widget('eucalyptus.newloadbalancer', $.eucalyptus.eucawidget, {
    options : {
      instance: null,
    },
    _init : function() {
      ...
      $('html body').eucadata('setDataNeeds', ['instances']);
      require(['views/newloadbalancer/index'], function(WizardFactory) {
        var View = WizardFactory(thisObj.options);
        var view = new View({el: thisObj.element});
      	view.render();
//        var loadBalancerHelp = $('#load-balancer-wizard-help');
//        thisObj._addHelp(loadBalancerHelp);
      });
    },
