...
,
        ...
        columnMapForSort: [
                  {name:'instances', column:[{id:'1', value:'display_id'}, {id:'2', value:'state'}, {id:'12', value:'state'}, {id:'3', value:'image_id'}, {id:'4', value:'placement'}, {id:'5', value:'public_dns_name'}, {id:'6', value:'private_dns_name'}, {id:'7', value:'key_name'}, {id:'8', value:'group_name'}, {id:'11', value:'root_device_name'}, {id:'9', value:'launch_time'}, {id:'13', value:'launch_time'},{id:'16', value:'ip_address'}, {id:'17', value:'id'}, {id:'18', value:'display_id'} ]},
                  {name:'images', column:[{id:'1', value:'display_id'}, {id:'2', value:'name'}, {id:'3', value:'id'}, {id:'4', value:'architecture'}, {id:'5', value:'description'}, {id:'6', value:'root_device_type'}, {id:'10', value:'id'}]},
                  {name:'volumes', column:[{id:'1', value:'display_id'}, {id:'2', value:'status'}, {id:'8', value:'status'}, {id:'3', value:'size'}, {id:'4', value:'display_instance_id'}, {id:'5', value:'display_snapshot_id'}, {id:'6', value:'zone'}, {id:'7', value:'create_time'}, {id:'9', value:'create_time'}, {id:'10', value:'id'}]},
                  {name:'snapshots', column:[{id:'1', value:'display_id'}, {id:'2', value:'status'}, {id:'7', value:'status'}, {id:'3', value:'volume_size'}, {id:'4', value:'display_volume_id'}, {id:'5', value:'description'}, {id:'9', value:'description'}, {id:'6', value:'start_time'}, {id:'8', value:'start_time'}, {id:'10', value:'id'}]}
,
